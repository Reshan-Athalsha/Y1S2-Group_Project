...
<head>
    ...
    <title>Edit User — Wedding Planner</title>
        ...
        <form action="${pageContext.request.contextPath}/users?action=update" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="password"
                       name="password" value="${user.password}" required minlength="4" />
                <div class="form-text">For this demo, the password is shown in plaintext to make grading easier.</div>
            </div>
