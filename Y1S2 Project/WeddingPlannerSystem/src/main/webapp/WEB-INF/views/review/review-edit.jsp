...
<head>
    ...
    <title>Edit Review — Wedding Planner</title>
...
<div class="container my-5">
    <div class="form-section mx-auto" style="max-width: 600px;">
        ...
        <form action="${pageContext.request.contextPath}/reviews?action=update" method="post">
            
            <input type="hidden" name="id" value="${review.id}" />

            <div class="mb-3">
                <label for="userId" class="form-label">User ID</label>
                <input type="number" class="form-control" id="userId" name="userId" value="${review.userId}" required />
            </div>

            <div class="mb-3">
                <label for="vendorId" class="form-label">Vendor ID</label>
                <input type="number" class="form-control" id="vendorId" name="vendorId" value="${review.vendorId}" required />
            </div>
